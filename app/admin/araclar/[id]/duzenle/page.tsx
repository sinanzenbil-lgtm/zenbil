  ...
  const fetchVehicle = async () => {
    try {
      ...
      setFormData({
        ...
        locationIds: vehicle.locations.map((l: any) => l.locationId),
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Araç bilgilerini güncelleyin</p>
        </div>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <Button
                type="submit"
                className="w-full"
                disabled={submitting || formData.locationIds.length === 0}
              >
